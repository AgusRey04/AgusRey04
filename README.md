...
<a href="mailto:reymundez37@gmail.com">
...
<img src="https://cdn.simpleicons.org/bruno/FFFFFF" width="40"/>
<br><br>
</td>
...
<!--  <img src="assets/eduplanner-card.png" width="100%" alt="EduPlanner"/>
-->
</a>
...
Genera planificaciones educativas mediante Inteligencia Artificial.

**Stack**

`React` • `Express` • `PostgreSQL` • `Gemini AI` • `JWT` • `Amazon S3`
...
<!-- <img src="assets/entretodos-card.png" width="100%" alt="EntreTodos"/>
-->
</a>
...
Autenticación JWT, roles y Clean Architecture.

**Stack**

`.NET 10`  • `ASP.NET Core` • `Entity Framework` • `MySQL`
...
`React` • `Express` • `Bootstrap` • `SQLite`
...
<img src="https://img.shields.io/badge/Portfolio-24292F?style=for-the-badge&logo=vercel"/>
